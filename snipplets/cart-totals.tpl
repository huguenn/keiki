...
{% if not cart_page %}
  ...
  <h5 class="js-visible-on-cart-filled row mb-1" {% if cart.items_count == 0 %}style="display:none;"{% endif %}>
        ...
        <div id="cart-sticky-summary" class="position-sticky-md row justify-content-end mt-3 mt-md-0">
          <div class="col-12 col-md-6">
            <div class="box box-border float-right">
              ...
              <h5 class="js-visible-on-cart-filled row font-weight-normal mb-0" {% if cart.items_count == 0 %}style="display:none;"{% endif %}>
                <span class="col-7">
                  {{ "Subtotal" | translate }}:
                </span>
    ...
    {% endif %}
              ...
              <div class="js-cart-total-container js-visible-on-cart-filled mb-3" {% if cart.items_count == 0 %}style="display:none;"{% endif %} data-store="cart-total">
                <h2 class="row text-primary mb-0">
                  ...
                  <span class="js-cart-total {% if cart.free_shipping.cart_has_free_shipping %}js-free-shipping-achieved{% endif %} {% if cart.shipping_data.selected %}js-cart-saved-shipping{% endif %} col text-right">{{ cart.total | money }}</span>
                </h2>
