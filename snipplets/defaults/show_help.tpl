		...
		<div class="placeholder-overlay placeholder-slider transition-soft">
            <div class="placeholder-info">
                ...
                {% if not params.preview %}
                    <a href="/admin/themes/settings/#instatheme=pagina-de-inicio" class="btn-secondary btn btn-small placeholder-button">{{ "Editar" | translate }}</a>
                {% endif %}
            </div>
        </div>
	...
	<div id="instafeed" class="row no-gutters position-relative">
		...
		<div class="placeholder-overlay transition-soft">
            <div class="placeholder-info">
                ...
                {% if not params.preview %}
                    <a href="/admin/themes/settings/#instatheme=redes-sociales" class="btn-secondary btn btn-small placeholder-button">{{ "Editar" | translate }}</a>
                {% endif %}
            </div>
        </div>
	</div>
