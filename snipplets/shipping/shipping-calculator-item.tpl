...
<li class="js-shipping-list-item radio-button-item float-left w-100" data-store="shipping-calculator-item-{{ option.code }}">
    <label class="js-shipping-radio radio-button list-item" data-loop="shipping-radio-{{loop.index}}" data-shipping-type="{% if pickup %}pickup{% else %}delivery{% endif %}">
        <input
            ...
            <div class="radio-button-label">
                ...
                <div class="radio-button-text row"> 
                    <div class="col-8 col-md-9 font-small pr-0">
                        <div class="{% if option.payment_rules or option.time or option.suboptions is not empty %}mb-2{% endif %}">
                            {{option.short_name}} <span class="ml-1">{{ option.method == 'branch'  ? option.extra.extra  :  '' }}</span>
                        </div>
                        {% if option.time %}
                            <div class="opacity-60 {% if option.suboptions is not empty or option.payment_rules %}mb-2{% endif %}">
