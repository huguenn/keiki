...
<div class="mb-2 col-12" data-store="shipping-calculator">
	...
	<div class="js-shipping-calculator-head shipping-calculator-head position-relative transition-soft {% if cart.shipping_zipcode %}with-zip{% else %}with-form{% endif %} {% if free_shipping_messages_visible %}with-free-shipping{% endif %}">
		...
		<div class="js-shipping-calculator-form shipping-calculator-form transition-up position-absolute">
			...
			{% endblock input_append_content %}
				...
				{% if store.country == 'BR' or 'AR' or 'MX' %}
					...
					<div class="col-12">
						<a class="font-small text-primary mt-2 mb-2 d-block" href="{% if store.country == 'AR' %}{{ zipcode_help_ar }}{% elseif store.country == 'BR' %}{{ zipcode_help_br }}{% elseif store.country == 'MX' %}{{ zipcode_help_mx }}{% endif %}" target="_blank">{{ "No sé mi código postal" | translate }}</a>
					</div>
				{% endif %}
				<div class="col-12">
