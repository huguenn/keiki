...
{% if show_labels %}
  <div class="{% if product.video_url and product %}js-labels-group{% endif %} labels {% if product_detail and has_multiple_slides %}labels-product-slider{% endif %}">
    ...
    {% else %}
      ...
      {% if product.compare_at_price or product.promotional_offer %}
        <div class="{% if not product.promotional_offer and product %}js-offer-label{% endif %} label label-accent {% if not product.promotional_offer %}label-circle{% endif %}" {% if (not product.compare_at_price and not product.promotional_offer) or not product.display_price %}style="display:none;"{% endif %}>
          ...
          {% elseif product.promotional_offer %}
            ...
            {% endif %}
          {% else %}
            <span {% if product_detail or color %}class="js-offer-percentage"{% endif %}>
