		...
		<div class="col-md-6 col-lg-4">
			...
			{% elseif account_validation == 'expired' %}
				...
				<div class="text-center mb-4 font-small">
					<span class="js-resend-validation-link btn-link btn-link-primary">{{ "Enviar link de nuevo >" | translate }}</span>
				</div>
			{% elseif account_validation == 'pending' %}
				...
				<div class="text-center mb-4 font-small">
					<p>{{ "¿No lo encontraste?" | translate }} <span class="js-resend-validation-link btn-link btn-link-primary">{{ "Enviar link de nuevo" | translate }}</span></p>
				</div>
			{% endif %}
